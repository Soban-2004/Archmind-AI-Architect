...
async def migration_blueprint(project_id: UUID, reconstructed_version: UUID, target_version: UUID):
    ...
    try:
        return await generate_migration_blueprint(project_id, reconstructed_version, target_version)
