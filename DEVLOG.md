# AI Architect — Build Log

This is the real, chronological engineering record: every bug a live run
(a real Groq key, a real Supabase database, real repos fed through
ingestion) actually surfaced, what was wrong, how it was found, and how
it was fixed and re-verified — not a cleaned-up summary written after
the fact. If you're looking for "what is this project and how do I run
it," that's the main [README](./README.md); this file is for anyone who
wants the reasoning behind a specific decision, or just wants to see how
the thing actually got built.

Sections run in the order they happened.
